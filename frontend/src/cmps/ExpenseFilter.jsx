...
import { TextField, OutlinedInput, ListItemText, FormControl, InputLabel, MenuItem, Select, Stack } from '@mui/material'
...
export function ExpenseFilter({ filterBy, onSetFilter }) {
    ...
    }, [selectedCategories, selectedDate, selectedSort])
